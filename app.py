...
with tab2:
    st.info('This is a Laptop Price Prediction web app, which predicts the approximate price of the laptop for required configuration.\n'
    ...
    st.warning('User should be noticed that this webapp may not give the actual price. To know actual price please kindly \n'
